...
void findAllWordsFromNode(TstNode *root, const char *prefix, char *buffer,
                          int depth);

void completWord(TstNode *root, const char *prefix);

void collectNextCharacters(TstNode *root, char *buffer, int depth,
                           char *nextChars, int *charCount);
